<%-- 
    Document   : user
    Created on : Jan 9, 2021, 5:33:40 PM
    Author     : mevrthisbang
--%>
...
<c:if test="${sessionScope.USER!=null&& sessionScope.USER.role eq 'user'}" var="testRole">
    <html>
        ...
        <body>
            ...
            <div class="center"><font color="red">Welcome user, ${sessionScope.USER.fullname}</font></div>
            <div class="center"><font color="red">${requestScope.SUCCESS}</font></div>
                                        ...
                                        <form action="MainController" method="POST">
                                            ...
                                            <div class="product_list" style="background-color: #F0EEEE; min-height: 350px;">
                                                ...
                                                <div class="center">
                                                    ...
                                                    <input type="hidden" value="${param.txtFrom}" name="txtFrom"/>
                                                    <input type="hidden" value="${param.txtTo}" name="txtTo"/>
                                                    <input type="hidden" value="${param.cboCategory}" name="cboCategory"/>
